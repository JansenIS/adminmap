...
if ($method === 'GET') {
  api_json_response(['ok' => true, 'config' => vk_bot_load_config()], 200, vk_bot_data_mtime());
}
...
if (!vk_bot_save_config($cfg)) api_json_response(['error' => 'write_failed'], 500, vk_bot_data_mtime());
api_json_response(['ok' => true, 'config' => vk_bot_load_config()], 200, vk_bot_data_mtime());
