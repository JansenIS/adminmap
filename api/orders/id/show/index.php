...
if ($ifNoneMatch !== '' && $ifNoneMatch === orders_api_order_etag($order)) {
...
orders_api_response(['ok'=>true,'order'=>orders_api_filter_public($order,$isAdmin,true),'etag'=>orders_api_order_etag($order)]);
