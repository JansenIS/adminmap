...
if (isset($payload['public_images']) && is_array($payload['public_images'])) $order['public_images'] = array_values(array_filter($payload['public_images'], static fn($v)=>is_string($v)&&$v!==''));
