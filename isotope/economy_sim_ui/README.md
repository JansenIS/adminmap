...
- Полный промышленный граф из оригинального `resources.js`/`BUILDINGS` (с реальными recipe input/output по каждому товару), сейчас в PHP есть приближённые коэффициенты и влияние зданий.
