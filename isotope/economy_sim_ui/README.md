...
- В `admin_sim.php` добавлены: контуры провинций, режимы покраски (Королевства / ВД / МД), аккуратная маркировка особых территорий (free city) без перезаливки режима, и прозрачный режим (кружки-центры + контуры).
