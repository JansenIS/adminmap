...
- Полная рыночная механика ордербука (частичное исполнение, приоритет цены/времени, перенос заявок между годами) вместо текущей агрегированной записи заявок/сделок по итоговым потокам.
